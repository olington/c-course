...
/**
 Находит элементы массива src (pb_src - указатель на первый элементт, pe_src - указатель на элемент за последним), которые больше среднего арифметического. Перезаписывает данные элементы в массив dst (pb_dst - указатель на первый элементт, pe_dst - указатель на элемент за последним).
 ...
 @return 0, если функция выполнена успешно, иначе код ошибки
 */
